# 🔐 OpenBAO Setup voor n8n Integratie

OpenBAO (Open Build, Authenticate, and Operate) is een open-source fork van HashiCorp Vault die volledig open-source blijft onder de MPL 2.0 licentie. Deze setup is specifiek ontworpen voor integratie met n8n workflows, waarbij voor elke klant aparte secrets worden beheerd.

## 📋 Inhoudsopgave

- [Wat is OpenBAO?](#wat-is-openbao)
- [Waarom OpenBAO voor n8n?](#waarom-openbao-voor-n8n)
- [Installatie](#installatie)
- [Snelstart](#snelstart)
- [Scripts Uitleg](#scripts-uitleg)
- [Klanten Beheren](#klanten-beheren)
- [n8n Integratie](#n8n-integratie)
...
## 🤔 Waarom OpenBAO voor n8n?

Bij het werken met n8n workflows is het belangrijk om gevoelige gegevens zoals API keys veilig op te slaan. Door OpenBAO te gebruiken:

1. **Houd je secrets buiten n8n**: Geen API keys in je workflows
2. **Klantspecifieke secrets**: Elke klant heeft zijn eigen geïsoleerde omgeving
3. **Dynamische toegang**: Workflows kunnen dynamisch secrets ophalen op basis van klant-ID
